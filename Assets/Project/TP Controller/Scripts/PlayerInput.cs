...
public static class PlayerInput
{
    ...
    public static float _horizontalAxisCam = 3.5f;
    public static float _verticalAxisCam = 3.5f;
    ...
    public static Quaternion GetMouseRotationInput(float horizontalSensitivity = 3f, float verticalSensitivity = 3f, float minTiltAngle = -75f, float maxTiltAngle = 45f)
    {
        ...
        Debug.Log(horizontalSensitivity + "  " + verticalSensitivity);
        // Adjust the look angle (Y Rotation)
        lookAngle += mouseX * horizontalSensitivity;
        lookAngle %= 360f;

        // Adjust the tilt angle (X Rotation)
        tiltAngle += mouseY * verticalSensitivity;
        tiltAngle %= 360f;
